...
menu() {
	cd "$HOME" || exit
	echoContent red "\n=============================================================="
	echoContent green "作者:mack-a （已删库）"
	echoContent green "当前版本:v2.5.78 （原作者fork版）"
	echoContent green "Github:https://github.com/wangn9900/v2ray-agent"
	echoContent green "描述:八合一共存脚本\c"
	showInstallStatus
	echoContent red "\n=============================================================="
	echoContent red "                        推广区                      "
	echoContent green "优质机场推荐：https://tianquege.top\n"
	echoContent green "奈飞合租车：https://ihezu.video/TXMpfA"
	echoContent red "=============================================================="
	if [[ -n "${coreInstallType}" ]]; then
